...
export const SeiPatronABI = [
	...
	},
	{
		"inputs": [
			...
			{
				"internalType": "enum SeiPatron.ContentType",
				"name": "_contentType",
				"type": "uint8"
			},
			{
		...
		"outputs": [
			{
				...
				"internalType": "struct SeiPatron.Comment[]",
				"name": "",
				"type": "tuple[]"
			}
		],
	...
	},
	{
		...
		"outputs": [
			{
				"internalType": "enum SeiPatron.SubscriptionStatus",
				"name": "",
				"type": "uint8"
			}
		],
		...
		"outputs": [
			{
				...
				"internalType": "struct SeiPatron.SubscriptionTier",
				"name": "",
				"type": "tuple"
			}
		],
...
export const SeiPatronAddress = '0x3b6B7da4E3f16dbE179a0743c12Ef4C20a82C6fb';
